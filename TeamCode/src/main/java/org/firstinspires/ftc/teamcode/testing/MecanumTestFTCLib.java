...
@TeleOp(name = "Mecanum Test FTCLib", group = "unittest")
public class MecanumTestFTCLib extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        rl = new Motor(hardwareMap, "rearLeft");
        rr = new Motor(hardwareMap, "rearRight");
